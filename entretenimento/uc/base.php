...
<html>
  <head>
    ...
    <link href="comuns/plugins/bootstrap-tag/bootstrap-tagsinput.css" rel="stylesheet" type="text/css" />
  ...
  <body class="fixed-header   ">
    ...
    <nav class="page-sidebar" data-pages="sidebar">
      ...
      <div class="sidebar-overlay-slide from-top" id="appMenu">
        <div class="row">
          <div class="col-xs-6 no-padding">
            <a href="#" class="p-l-40"><img src="comuns/img/demo/social_app.svg" alt="socail">
            </a>
          </div>
          <div class="col-xs-6 no-padding">
            <a href="#" class="p-l-10"><img src="comuns/img/demo/email_app.svg" alt="socail">
            </a>
          </div>
        </div>
        <div class="row">
          <div class="col-xs-6 m-t-20 no-padding">
            <a href="#" class="p-l-40"><img src="comuns/img/demo/calendar_app.svg" alt="socail">
            </a>
          </div>
          <div class="col-xs-6 m-t-20 no-padding">
            <a href="#" class="p-l-10"><img src="/comuns/img/demo/add_more.svg" alt="socail">
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="sidebar-header">
        <img src="comuns/img/logo_white.png" alt="logo" class="brand" data-src="comuns/img/logo_white.png" data-src-retina="comuns/img/logo_white_2x.png" width="78" height="22">
        ...
        <div class="pull-center sm-table">
          <div class="header-inner">
            ...
            <div class="brand inline">
              <img src="comuns/img/logo.png" alt="logo" data-src="comuns/img/logo.png" data-src-retina="comuns/img/logo_2x.png" width="78" height="22">
            </div>
                        ...
                        <div class="notification-item unread clearfix">
                          <div class="heading">
                            <div class="thumbnail-wrapper d24 circular b-white m-r-5 b-a b-white m-t-10 m-r-10">
                              <img width="30" height="30" data-src-retina="comuns/img/profiles/1x.jpg" data-src="comuns/img/profiles/1.jpg" alt="" src="comuns/img/profiles/1.jpg">
                            </div>
                            <a href="#" class="text-complete">
          ...
          <div class="visible-lg visible-md m-t-10">
            ...
            <div class="dropdown pull-right">
              <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img src="/comuns/img/profiles/avatar.jpg" alt="" data-src="/comuns/img/profiles/avatar.jpg" data-src-retina="/comuns/img/profiles/avatar_small2x.jpg" width="32" height="32">
            </span>
              </button>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        ...
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="comuns/img/profiles/1x.jpg" data-src="comuns/img/profiles/1.jpg" src="comuns/img/profiles/1x.jpg" class="col-top">
                        </span>
                        </span>
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="comuns/img/profiles/2x.jpg" data-src="comuns/img/profiles/2.jpg" src="comuns/img/profiles/2x.jpg" class="col-top">
                        </span>
                        </span>
                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="comuns/img/profiles/3x.jpg" data-src="comuns/img/profiles/3.jpg" src="comuns/img/profiles/3x.jpg" class="col-top">
                        </span>
                        </span>
                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="comuns/img/profiles/5x.jpg" data-src="comuns/img/profiles/5.jpg" src="comuns/img/profiles/5x.jpg" class="col-top">
                        </span>
                        </span>
                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="comuns/img/profiles/6x.jpg" data-src="comuns/img/profiles/6.jpg" src="comuns/img/profiles/6x.jpg" class="col-top">
                        </span>
                        </span>
                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="comuns/img/profiles/7x.jpg" data-src="comuns/img/profiles/7.jpg" src="comuns/img/profiles/7x.jpg" class="col-top">
                        </span>
                        </span>
                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="comuns/img/profiles/8x.jpg" data-src="comuns/img/profiles/8.jpg" src="comuns/img/profiles/8x.jpg" class="col-top">
                        </span>
                        </span>
                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="comuns/img/profiles/9x.jpg" data-src="comuns/img/profiles/9.jpg" src="comuns/img/profiles/9x.jpg" class="col-top">
                        </span>
                        </span>
                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
              ...
              <div class="chat-inner" id="my-conversation">
                ...
                <div class="message clearfix">
                  <div class="profile-img-wrapper m-t-5 inline">
                    <img class="col-top" width="30" height="30" src="comuns/img/profiles/avatar_small.jpg" alt="" data-src="comuns/img/profiles/avatar_small.jpg" data-src-retina="comuns/img/profiles/avatar_small2x.jpg">
                  </div>
    ...
    <div class="overlay hide" data-pages="search">
      ...
      <div class="overlay-content has-results m-t-20">
        ...
        <div class="container-fluid">
          <!-- BEGIN Overlay Logo !-->
          <img class="overlay-brand" src="comuns/img/logo.png" alt="logo" data-src="comuns/img/logo.png" data-src-retina="comuns/img/logo_2x.png" width="78" height="22">
          <!-- END Overlay Logo !-->
          <!-- BEGIN Overlay Close !-->
              ...
              <div class="col-md-6">
                ...
                <div class="">
                  ...
                  <div class="thumbnail-wrapper d48 circular bg-success text-white inline m-t-10">
                    <div>
                      <img width="50" height="50" src="comuns/img/profiles/avatar.jpg" data-src="comuns/img/profiles/avatar.jpg" data-src-retina="comuns/img/profiles/avatar2x.jpg" alt="">
                    </div>
                  </div>
    ...
    <script type="text/javascript" src="comuns/plugins/bootstrap-tag/bootstrap-tagsinput.min.js"></script>
