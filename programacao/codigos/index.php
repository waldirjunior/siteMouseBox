...
include $_SERVER['DOCUMENT_ROOT']."/comuns/funcoes/posts.php";
  ...
  $tempPosts->id = $id;
  $novoid = $tempPosts->retornarvalorid($id);
...
<html>
  <head>
    ...
    <meta charset="utf-8" />
    <title><?php echo $novoid['post_title'] ?></title>
    ...
    <script type="text/javascript" src="/programacao/base/comuns/geral/js/core/libraries/jquery.min.js"></script>
    <script type="text/javascript" src="/programacao/base/comuns/geral/js/plugins/editors/ace/ace.js"></script>
    <script type="text/javascript" src="/programacao/base/comuns/geral/js/comuns/editor_code.js"></script>
    ...
    <div class="page-container">
      <?php include($_SERVER['DOCUMENT_ROOT']."/topo/header.php"); ?>
        <div id="principal">
            ...
            if( file_exists( "base/" . $modulo . ".php" ) )
                require "base/" . $modulo . ".php";
            else
                require $_SERVER['DOCUMENT_ROOT']."/programacao/estrutura/404.php";
            ?>
        </div>
