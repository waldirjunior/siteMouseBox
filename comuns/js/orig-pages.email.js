        ...
        success: function(data) {
            ...
            $.each(data.emails, function(i) {
                ...
                $.each(list, function(j) {
                    ...
                    var result = foo();
                    var titulorig = result.titulo;
                    var conteudorig = result.conteudo;
                    var imgts = result.img;
                    var sub = result.sub;
                    var datagame = result.data;
                    ...
                    var li = '<li class="item padding-15" data-email-id="' + id + '"> \
                                <div class="thumbnail-wrapper d32 circular bordered ' + color + '"> \
                                    <img width="40" height="40" alt="" data-src-retina="' + dpRetina + '" data-src="' + dp + '" src="/backend/incluir/postgame/admin/img/' + imgts + '"> \
                                </div> \
