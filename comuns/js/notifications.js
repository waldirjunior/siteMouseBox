        ...
        $('.show-notification').click(function(e) {
            ...
            if (style == 'Notification Bar') {
                ...
                $('body').pgNotification({
                    ...
                    timeout: 0,
                    type: type,
                    thumbnail: '<img width="40" height="40" style="display: inline-block;" src="comuns/img/profiles/avatar2x.jpg" data-src="comuns/img/profiles/avatar.jpg" data-src-retina="comuns/img/profiles/avatar2x.jpg" alt="">'
                }).show();
